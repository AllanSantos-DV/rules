...
async function preloadDescriptions(){
  const files = [
    'assets/docs/backend/java/arch-mvc.md',
    'assets/docs/backend/java/arch-hexagonal.md',
    'assets/docs/backend/java/framework-spring-boot-2x.md',
    'assets/docs/backend/java/framework-spring-boot-3x.md',
    'assets/docs/backend/java/framework-quarkus-2x.md',
    'assets/docs/backend/java/framework-quarkus-3x.md',
    'assets/docs/backend/java/framework-micronaut-3x.md',
    'assets/docs/backend/java/framework-micronaut-4x.md',
    'assets/docs/backend/java/version-11.md',
    'assets/docs/backend/java/version-17.md',
    'assets/docs/backend/java/version-21.md',
    // Python
  'assets/docs/backend/python/framework-django.md',
  'assets/docs/backend/python/framework-flask.md',
  'assets/docs/backend/python/framework-fastapi.md',
  'assets/docs/backend/python/arch-mvc.md',
  'assets/docs/backend/python/arch-hexagonal.md',
  'assets/docs/backend/python/version-3.8.md',
  'assets/docs/backend/python/version-3.10.md',
  'assets/docs/backend/python/version-3.12.md',
    // Web
  'assets/docs/web/stack-html-css-js.md',
  'assets/docs/web/stack-react.md',
  'assets/docs/web/stack-angular.md',
  'assets/docs/web/stack-vue.md',
  'assets/docs/web/arch-spa.md',
  'assets/docs/web/arch-ssr.md',
  'assets/docs/web/arch-microfrontends.md',
  'assets/docs/web/css-tailwind.md',
  'assets/docs/web/css-bootstrap.md',
  'assets/docs/web/css-mui.md'
    ,
    // Desktop (Python)
    'assets/docs/desktop/python/framework-pyside6.md',
    'assets/docs/desktop/python/framework-tkinter.md',
    'assets/docs/desktop/python/framework-kivy.md',
    'assets/docs/desktop/python/arch-mvvm.md',
    'assets/docs/desktop/python/arch-mvc.md',
    'assets/docs/desktop/python/version-3.13.md',
    'assets/docs/desktop/windows-distribution.md'
  ];
  const descMap = {};
  try{
