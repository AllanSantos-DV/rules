...
async function preloadDescriptions(){
  const files = [
    'assets/markdown/backend/java/arch-mvc.md',
    'assets/markdown/backend/java/arch-hexagonal.md',
    'assets/markdown/backend/java/framework-spring-boot-2x.md',
    'assets/markdown/backend/java/framework-spring-boot-3x.md',
    'assets/markdown/backend/java/framework-quarkus-2x.md',
    'assets/markdown/backend/java/framework-quarkus-3x.md',
    'assets/markdown/backend/java/framework-micronaut-3x.md',
    'assets/markdown/backend/java/framework-micronaut-4x.md',
    'assets/markdown/backend/java/version-11.md',
    'assets/markdown/backend/java/version-17.md',
    'assets/markdown/backend/java/version-21.md',
    // Python
  'assets/markdown/backend/python/framework-django.md',
  'assets/markdown/backend/python/framework-flask.md',
  'assets/markdown/backend/python/framework-fastapi.md',
  'assets/markdown/backend/python/arch-mvc.md',
  'assets/markdown/backend/python/arch-hexagonal.md',
  'assets/markdown/backend/python/version-3.8.md',
  'assets/markdown/backend/python/version-3.10.md',
  'assets/markdown/backend/python/version-3.12.md',
    // Web
  'assets/markdown/web/stack-html-css-js.md',
  'assets/markdown/web/stack-react.md',
  'assets/markdown/web/stack-angular.md',
  'assets/markdown/web/stack-vue.md',
  'assets/markdown/web/arch-spa.md',
  'assets/markdown/web/arch-ssr.md',
  'assets/markdown/web/arch-microfrontends.md',
  'assets/markdown/web/css-tailwind.md',
  'assets/markdown/web/css-bootstrap.md',
  'assets/markdown/web/css-mui.md'
    ,
    // Desktop (Python)
    'assets/markdown/desktop/python/framework-pyside6.md',
    'assets/markdown/desktop/python/framework-tkinter.md',
    'assets/markdown/desktop/python/framework-kivy.md',
    'assets/markdown/desktop/python/arch-mvvm.md',
    'assets/markdown/desktop/python/arch-mvc.md',
    'assets/markdown/desktop/python/version-3.13.md',
    'assets/markdown/desktop/windows-distribution.md'
  ];
  const descMap = {};
  try{
