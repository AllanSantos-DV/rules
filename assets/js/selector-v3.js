...
async function preloadDescriptions(){
  const files = [
    'content/backend/java/arch-mvc.md',
    'content/backend/java/arch-hexagonal.md',
    'content/backend/java/framework-spring-boot-2x.md',
    'content/backend/java/framework-spring-boot-3x.md',
    'content/backend/java/framework-quarkus-2x.md',
    'content/backend/java/framework-quarkus-3x.md',
    'content/backend/java/framework-micronaut-3x.md',
    'content/backend/java/framework-micronaut-4x.md',
    'content/backend/java/version-11.md',
    'content/backend/java/version-17.md',
    'content/backend/java/version-21.md',
    // Python
  'content/backend/python/framework-django.md',
  'content/backend/python/framework-flask.md',
  'content/backend/python/framework-fastapi.md',
  'content/backend/python/arch-mvc.md',
  'content/backend/python/arch-hexagonal.md',
  'content/backend/python/version-3.8.md',
  'content/backend/python/version-3.10.md',
  'content/backend/python/version-3.12.md',
    // Web
  'content/web/stack-html-css-js.md',
  'content/web/stack-react.md',
  'content/web/stack-angular.md',
  'content/web/stack-vue.md',
  'content/web/arch-spa.md',
  'content/web/arch-ssr.md',
  'content/web/arch-microfrontends.md',
  'content/web/css-tailwind.md',
  'content/web/css-bootstrap.md',
  'content/web/css-mui.md'
    ,
    // Desktop (Python)
    'content/desktop/python/framework-pyside6.md',
    'content/desktop/python/framework-tkinter.md',
    'content/desktop/python/framework-kivy.md',
    'content/desktop/python/arch-mvvm.md',
    'content/desktop/python/arch-mvc.md',
    'content/desktop/python/version-3.13.md',
    'content/desktop/windows-distribution.md'
  ];
  const descMap = {};
  try{
