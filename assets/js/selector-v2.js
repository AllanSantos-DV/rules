...
async function preloadDescriptions(){
  const files = [
    'markdown-docs/backend/java/arch-mvc.md',
    'markdown-docs/backend/java/arch-hexagonal.md',
    'markdown-docs/backend/java/framework-spring-boot-2x.md',
    'markdown-docs/backend/java/framework-spring-boot-3x.md',
    'markdown-docs/backend/java/framework-quarkus-2x.md',
    'markdown-docs/backend/java/framework-quarkus-3x.md',
    'markdown-docs/backend/java/framework-micronaut-3x.md',
    'markdown-docs/backend/java/framework-micronaut-4x.md',
    'markdown-docs/backend/java/version-11.md',
    'markdown-docs/backend/java/version-17.md',
    'markdown-docs/backend/java/version-21.md',
    // Python
  'markdown-docs/backend/python/framework-django.md',
  'markdown-docs/backend/python/framework-flask.md',
  'markdown-docs/backend/python/framework-fastapi.md',
  'markdown-docs/backend/python/arch-mvc.md',
  'markdown-docs/backend/python/arch-hexagonal.md',
  'markdown-docs/backend/python/version-3.8.md',
  'markdown-docs/backend/python/version-3.10.md',
  'markdown-docs/backend/python/version-3.12.md',
    // Web
  'markdown-docs/web/stack-html-css-js.md',
  'markdown-docs/web/stack-react.md',
  'markdown-docs/web/stack-angular.md',
  'markdown-docs/web/stack-vue.md',
  'markdown-docs/web/arch-spa.md',
  'markdown-docs/web/arch-ssr.md',
  'markdown-docs/web/arch-microfrontends.md',
  'markdown-docs/web/css-tailwind.md',
  'markdown-docs/web/css-bootstrap.md',
  'markdown-docs/web/css-mui.md'
    ,
    // Desktop (Python)
    'markdown-docs/desktop/python/framework-pyside6.md',
    'markdown-docs/desktop/python/framework-tkinter.md',
    'markdown-docs/desktop/python/framework-kivy.md',
    'markdown-docs/desktop/python/arch-mvvm.md',
    'markdown-docs/desktop/python/arch-mvc.md',
    'markdown-docs/desktop/python/version-3.13.md',
    'markdown-docs/desktop/windows-distribution.md'
  ];
  const descMap = {};
  try{
